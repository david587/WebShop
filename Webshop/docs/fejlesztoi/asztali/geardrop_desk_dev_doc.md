...
admin/
  ...
  * user.component.html - felhasználók láthatóak
   ...
   * 'get' metódus típusa 'any', amely azt jelzi, hogy a metódus bármilyen típusú választ képes visszaadni.
  ...
  * 'data: any': Ez a bemeneti paraméter tartalmazza az adatokat, amelyeket az új termék létrehozásához szeretnénk felhasználni.
  * 'post' metódus típusa 'any', amely azt jelzi, hogy a metódus bármilyen típusú választ képes visszaadni.
 ...
 * 'id: number': Ez a bemeneti paraméter tartalmazza azon termék azonosítóját, amelyet törölni szeretnénk.
 * 'delete' metódus típusa 'any', amely azt jelzi, hogy a metódus bármilyen típusú választ képes visszaadni.
 ...
 * 'product: any': Ez a bemeneti paraméter tartalmazza azon termék objektumot, amelyet módosítani szeretnénk.
 * 'post' metódus típusa 'any', amely azt jelzi, hogy a metódus bármilyen típusú választ képes visszaadni.
 ...
 * 'id: any': Ez a bemeneti paraméter tartalmazza azon felhasználó azonosítóját, akinek admin jogot szeretnénk.
 * 'post' metódus típusa 'any', amely azt jelzi, hogy a metódus bármilyen típusú választ képes visszaadni.
 ...
 * 'id: number': Ez a bemeneti paraméter tartalmazza azon felhasználó azonosítóját, amelyet törölni szeretnénk.
 * 'delete' metódus típusa 'any', amely azt jelzi, hogy a metódus bármilyen típusú választ képes visszaadni.
 ...
 * 'get' metódus típusa 'any', amely azt jelzi, hogy a metódus bármilyen típusú választ képes visszaadni.
  ...
  * 'data: any': Ez a bemeneti paraméter tartalmazza az adatokat, amelyeket az új márka létrehozásához szeretnénk felhasználni.
  * 'post' metódus típusa 'any', amely azt jelzi, hogy a metódus bármilyen típusú választ képes visszaadni.
 ...
 * 'id: number': Ez a bemeneti paraméter tartalmazza azon márka azonosítóját, amelyet törölni szeretnénk.
 * 'delete' metódus típusa 'any', amely azt jelzi, hogy a metódus bármilyen típusú választ képes visszaadni.
  ...
  * 'data: any': Ez a bemeneti paraméter tartalmazza az adatokat, amelyeket az új kategoria létrehozásához szeretnénk felhasználni.
  * 'post' metódus típusa 'any', amely azt jelzi, hogy a metódus bármilyen típusú választ képes visszaadni.
  ...
  * 'id: number': Ez a bemeneti paraméter tartalmazza azon kategoria azonosítóját, amelyet törölni szeretnénk.
  * 'delete' metódus típusa 'any', amely azt jelzi, hogy a metódus bármilyen típusú választ képes visszaadni.
